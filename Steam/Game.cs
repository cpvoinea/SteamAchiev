namespace Steam
{
    class Game
    {
        ...
        {
            return string.Join(',', new object[] { Id, $"\"{Name}\"", Type, IsFree, InitialPrice, FinalPrice, Metacritic, Recommendations, Year, Playtime, AchievCount, AchievDone, AchievPercent, Icon, Logo });
        }
